 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = (sec + 60 * min + 3600 * deg) * Math.PI / 180 / 3600
...
fun accountInThreeYears(initial: Int, percent: Int): Double =
    initial * 1.0 * (1 + percent * 1.0 / 100) * (1 + percent * 1.0 / 100) * (1 + percent * 1.0 / 100)
